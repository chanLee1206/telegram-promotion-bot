...
async def send_info_board(context: ContextTypes.DEFAULT_TYPE, chat_id: str) -> None:
    ...
    # Inline button structure with icons
    keyboard = [
        [
            InlineKeyboardButton("🌐 DexS", url="https://example.com/dexs"),
            InlineKeyboardButton("🔍 Sui Wallet Tracker", url="https://example.com/wallet"),
            InlineKeyboardButton("🎯 Sui Sniper Bot", url="https://example.com/sniper")
        ]
    ]
